...
<body>
 ...
 <div class="row">
	<div class="w3-content w3-section col-md-12 " style="max-width:450px;">
	    ...
	    <img class="mySlides" src="images/clothe/sale2.png"style="width:1348px;height: 500px;">
	</div>
</div>
                <script>
                    var mySlideShow = 0;
  ...
  <div class="grid-container">
            ...
            <div class="grid-item">
              <img class="img-fluid d-block mx-auto" src="<?php echo $clothes[$i]->getImagePath();?>" class="img-responsive" style="width:100%" alt="Image">
                ...
                <br>
                    <?php echo $clothes[$i]->getDisplayOldPrice() ?>
                </p>
              <form action="" method="post">
                  <button class="detail" name="detail" onclick="detail(<?php echo $result[$i][0];?>)">Detail</button>
                  <button class="add" name="insert_cart" value="<?php echo $result[$i][0];?>">Add</button>
              </form>
            </div>
	 ...
	 <hr style="color: white; margin-top: 0px; margin-bottom: 0px;">
         <footer class="page-footer font-small special-color-dark pt-4">
            ...
            <div class="footer-copyright text-center py-3"> Copyright by Ho Thi Mai:
                <a href="index.php"> FashionShop.com</a>
            </div>
        </footer>
</body>
</html>